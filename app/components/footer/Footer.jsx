        ...
        <div className="flex flex-wrap -mx-4 items-center">
          <div className="w-full lg:w-1/2 px-4 mb-4 lg:mb-0">
            <a className="inline-block" href="#">
              <img className="h-12" src="https://softnix.co/wp-content/themes/softnix/tmpl/assets/lp01/images/softnix-co-light.png" alt="" />
            </a>
          </div>
          <div className="w-full lg:w-1/2 px-4">
            <div className="sm:flex -mb-4 items-center lg:justify-end">
              <span className="inline-block text-gray-900 mb-4 mr-8">Ready to get collaborate?</span>
              <a className="relative group inline-block w-full sm:w-auto py-3 px-5 mb-4 text-center text-sm font-semibold text-orange-50 bg-orange-900 rounded-md overflow-hidden" href="#">
      ...
      <div className="flex flex-wrap -mx-4 mb-18">
        <div className="w-full lg:w-2/5 px-4 mb-12 lg:mb-0">
          <div className="xs:max-w-xs">
            <h4 className="font-heading text-2xl font-semibold text-gray-900 mb-4">Subscribe to our newsletter</h4>
            <form action="">
              <label className="block mb-1.5 text-sm font-semibold text-gray-900" for="">Email</label>
              <div className="xs:flex items-center">
                <div className="relative mb-4 xs:mb-0 xs:mr-4">
                  ...
                  <input className="w-full p-12 pr-4 py-4 text-sm text-gray-500 placeholder-gray-400 rounded-lg bg-white border border-gray-200 outline-none" type="email" placeholder="pat@shuffle.dev" />
                </div>
                <button className="flex flex-shrink-0 ml-auto xs:ml-0 items-center justify-center w-12 h-12 text-orange-50 bg-orange-900 hover:bg-gray-900 rounded-full transition duration-200" type="submit">
                  <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="w-full sm:w-1/3 lg:w-1/5 px-4 mb-8 sm:mb-0">
          ...
          <ul>
            <li className="mb-4"><a className="inline-block text-gray-500 hover:text-gray-600" href="#">Email Marketing</a></li>
            <li className="mb-4"><a className="inline-block text-gray-500 hover:text-gray-600" href="#">Campaigns</a></li>
            <li className="mb-4"><a className="inline-block text-gray-500 hover:text-gray-600" href="#">Branding</a></li>
            <li><a className="inline-block text-gray-500 hover:text-gray-600" href="#">Offline</a></li>
          </ul>
        </div>
        <div className="w-full sm:w-1/3 lg:w-1/5 px-4 mb-8 sm:mb-0">
          <h5 className="text-lg font-semibold text-gray-900 mb-3">About</h5>
          <ul>
            <li className="mb-4"><a className="inline-block text-gray-500 hover:text-gray-600" href="#">Our Story</a></li>
            <li className="mb-4"><a className="inline-block text-gray-500 hover:text-gray-600" href="#">Benefits</a></li>
            <li className="mb-4"><a className="inline-block text-gray-500 hover:text-gray-600" href="#">Team</a></li>
            <li><a className="inline-block text-gray-500 hover:text-gray-600" href="#">Careers</a></li>
          </ul>
        </div>
        <div className="w-full sm:w-1/3 lg:w-1/5 px-4">
          <h5 className="text-lg font-semibold text-gray-900 mb-4">Help</h5>
          <ul>
            <li className="mb-4"><a className="inline-block text-gray-500 hover:text-gray-600" href="#">FAQs</a></li>
            <li><a className="inline-block text-gray-500 hover:text-gray-600" href="#">Contact Us</a></li>
          </ul>
        </div>
      </div>
      <div className="sm:flex items-center justify-between">
        <div className="sm:flex mb-6 sm:mb-0 items-center"><a className="inline-block mr-6 sm:mr-12 text-gray-900 hover:text-gray-600" href="#">Terms & Conditions</a><a className="inline-block text-gray-900 hover:text-gray-600" href="#">Privacy Policy</a></div>
        <div className="flex items-center">
          ...
          <a className="inline-block mr-5 hover:bg-orange-50 rounded-md p-1" href="#">
            <img src="https://static.shuffle.dev/components/preview/2f808e47-944e-42cf-b821-2358251e0600/assets/public/saturn-assets/images/footers/icon-instagram.svg" alt="" />
          </a>
          <a className="inline-block mr-5 hover:bg-orange-50 rounded-md p-1" href="#">
