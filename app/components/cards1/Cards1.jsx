...
const Cards1 = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center lg:items-start lg:space-x-4 space-y-2 lg:space-y-0    ">
      ...
      {/* JEE Blogs Section */}
      <div className="flex flex-col md:flex-row justify-end mt-20 overflow-hidden shadow-lg border-1 border-black ">
  <div className="bg-white p-6 shadow-black w-full md:w-[435px] h-auto md:h-[360px] ml-0 md:ml-8 mt-8 ">
